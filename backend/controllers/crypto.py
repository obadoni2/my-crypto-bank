...
def get_all_crypto_currencies():
    url = "https://pro-api.coinmarketcap.com/v1/crytocurrency/map"
...
def exchange():
    ...
    if sell == "USD":
        ...
        iterator = filter(lambda x:x.name == buy. crypto currencies)
        ...
        crypto_account.amout += sum_to_pay
        db.session.commit()
        ...
        if crypto_currency == None: 
            return {"error": "you don't have thsi currency" }
